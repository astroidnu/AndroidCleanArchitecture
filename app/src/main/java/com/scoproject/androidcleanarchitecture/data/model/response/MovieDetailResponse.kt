...
sealed class MovieDetail {
    ...
    data class Response(
            ...
            @SerializedName("production_companies") val productionCompanies: ProductionCompanies? = null,
            @SerializedName("production_countries") val productionCountries: ProductionCountries? = null,
            @SerializedName("release_date") val releaseDate: String? = null,
            @SerializedName("revenue") val revenue: Int? = null,
            @SerializedName("runtime") val runtime: Int? = null,
            @SerializedName("spoken_languages") val spokenLanguages: SpokenLanguages? = null,
